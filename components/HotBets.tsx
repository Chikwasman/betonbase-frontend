    ...
    return (
      <div className="bg-white dark:bg-gray-900 rounded-xl p-8 shadow-sm border dark:border-gray-800">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">🔥 Hot Bets</h2>
        </div>
        <div className="text-center text-gray-500 dark:text-gray-400">Loading hot bets...</div>
      </div>
    );
  }
    ...
    return (
      <div className="bg-white dark:bg-gray-900 rounded-xl p-8 shadow-sm border dark:border-gray-800">
        ...
        <div className="text-center py-8">
          ...
          <p className="text-gray-500 dark:text-gray-400">No waiting bets yet</p>
          <p className="text-sm text-gray-400 dark:text-gray-500 mt-2">Be the first to place a bet!</p>
        </div>
      </div>
    );
  }
        ...
        {hotBets.slice(0, 6).map((bet) => {
          ...
          return (
            <Link
              ...
              className="border dark:border-gray-800 rounded-lg p-4 hover:border-primary dark:hover:border-primary hover:shadow-md transition-all cursor-pointer bg-white dark:bg-gray-900"
            >
              {/* Match Info */}
              <div className="mb-3">
